...
* If you are environment uses dockerconfig at the host to authenitcate to your private repository, update the value of secrets.yaml under helm/templates directory
